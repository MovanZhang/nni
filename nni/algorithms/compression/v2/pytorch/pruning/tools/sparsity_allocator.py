...
class Conv2dDependencyAwareAllocator(SparsityAllocator):
    ...
    def _get_dependency(self):
        ...
        self.channel_depen = ChannelDependency(None, None, traced_model=graph.trace).dependency_sets
        self.group_depen = GroupDependency(None, None, traced_model=graph.trace).dependency_sets
