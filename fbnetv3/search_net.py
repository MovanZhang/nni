...
def train_search_net(args):
    ...
    if args['recipe']['optim'] == 'SGD':
        optimizer = torch.optim.SGD(net.parameters(), lr=args['recipe']['lr'] * 0.0004, momentum=0.9, weight_decay=args['recipe']['wd'] * 0.000001)
    elif args['recipe']['optim'] == 'RMSProp':
        optimizer = torch.optim.RMSprop(net.parameters(), lr=args['recipe']['lr'] * 0.001, momentum=0.9, weight_decay=args['recipe']['wd'] * 0.000001)
